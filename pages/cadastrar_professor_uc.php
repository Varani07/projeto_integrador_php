        ...
        <main class="corpo">
            ...
            <section id="sectionMeio">
                <article id="articleTitulo">
                    <h2 class="h2Titulo">Inserir Professor em UC</h2>
                </article>
                            ...
                            <fieldset id="fieldsetLabel">
                                <fieldset id="bloco">
                                    <div class="dados">
                                        ...
                                        <select name="nome_professor">
                                            <option value="professor1" selected>Preencher com Professores Cadastrados</option>
                                        </select>
                                    </div>
                                </fieldset>
                                <fieldset id="bloco">
                                ...
                                <fieldset id="bloco">
                                    <div class="dados">
                                        ...
                                        <select name="nome_uc">
                                            <option value="uc1" selected>Preencher com Unidades Curriculares Cadastradas</option>
                                        </select>
                                    </div>
                                </fieldset>
                            </fieldset>
                ...
                <article id="articleButton">
                    <p class="pCenter" id="btns"><button type="submit" class="botao" id="btnLogin" name="btnInserir_professor_uc">Inserir</button></p>
                </article>
            </section>
            <hr id="hr1" />
            <footer>
