        ...
        <main class="corpo">
            ...
            <section id="sectionMeio">
                <article id="articleTitulo">
                    <h2 class="h2Titulo">Escolha um Curso e um Módulo para criar</h2>
                </article>
                            ...
                            <fieldset id="fieldsetLabel">
                                ...
                                <fieldset id="bloco">
                                    <div class="dados">
                                        <label>Módulo:</label>
                                        <select name="modulo">
                                            <option value="modulo_A" selected>Módulo A</option>
                ...
                <article id="articleButton">
                    <p class="pCenter" id="btns"><button type="submit" class="botao" id="btnLogin" name="btnCadastrar_Modulo">Cadastrar</button></p>
                </article>
            </section>
            <hr id="hr1" />
            <footer>
